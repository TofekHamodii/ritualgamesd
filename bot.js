...
if (message.content.startsWith(prefix + 'فكك')) {//الكود حق بوت Mal Team ♥
    if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));//الكود حق بوت Mal Team ♥

const type = require('./fkk.json');//الكود حق بوت Mal Team ♥
const item = type[Math.floor(Math.random() * type.length)];//الكود حق بوت Mal Team ♥
const filter = response => {
    return item.answers.some(answer => answer.toLowerCase() === response.content.toLowerCase());//الكود حق بوت Mal Team ♥
};
message.channel.send('**لديك 15 ثانيه لتفكيك الكلمه**').then(msg => {//الكود حق بوت Mal Team ♥
let embed = new Discord.RichEmbed()
.setColor("04791c")//الكود حق بوت Mal Team ♥
 .setImage(`${item.type}`)//الكود حق بوت Mal Team ♥
msg.channel.send(embed).then(() => {
        message.channel.awaitMessages(filter, { maxMatches: 1, time: 15000, errors: ['time'] })//الكود حق بوت Mal Team ♥
        .then((collected) => {
         const sh = new Discord.RichEmbed()
.setColor("04791c")
.setDescription('**? |Good Job +1P**')
.addField('Type G.mypoints', 'To Show ur Points' , true)//الكود حق بوت Mal Team ♥
.setFooter(message.author.username, message.author.avatarURL)//الكود حق بوت Mal Team ♥
...
client.on("message", function(message) {
   if(message.content.startsWith(prefix + "rps")) {
    ...
    message.channel.send(RpsEmbed).then(msg => {
        msg.react(' ??')////////الكود حق بوت Mal Team ♥
        msg.react("??")
        msg.react("??")////////الكود حق بوت Mal Team 
.then(() => msg.react('??'))/////////الكود حق بوت Mal Team 
.then(() =>msg.react('??'))/////////الكود حق بوت Mal Team 
.then(() => msg.react('??'))//////////الكود حق بوت Mal Team 
...
////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team 
const speed = [
    {
...
////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team 
       

        try{
////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team 
}catch(e){
 ...
 ////////الكود حق بوت Mal Team ////////الكود حق بوت Mal Team 
